...
func (uc *UserCreate) SetExpiredTime(s string) *UserCreate {
	uc.mutation.SetExpiredTime(s)
	return uc
}
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.ExpiredTime(); !ok {
		return &ValidationError{Name: "ExpiredTime", err: errors.New(`ent: missing required field "User.ExpiredTime"`)}
	}
	if _, ok := uc.mutation.CreatedAt(); !ok {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.ExpiredTime(); ok {
