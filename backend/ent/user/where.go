...
// LoginToken applies equality check predicate on the "LoginToken" field. It's identical to LoginTokenEQ.
func LoginToken(v string) predicate.User {
	return predicate.User(sql.FieldEQ(FieldLoginToken, v))
}

// ExpiredTime applies equality check predicate on the "ExpiredTime" field. It's identical to ExpiredTimeEQ.
func ExpiredTime(v string) predicate.User {
	return predicate.User(sql.FieldEQ(FieldExpiredTime, v))
}
...
// LoginTokenEQ applies the EQ predicate on the "LoginToken" field.
func LoginTokenEQ(v string) predicate.User {
	return predicate.User(sql.FieldEQ(FieldLoginToken, v))
}

// LoginTokenNEQ applies the NEQ predicate on the "LoginToken" field.
func LoginTokenNEQ(v string) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldLoginToken, v))
}

// LoginTokenIn applies the In predicate on the "LoginToken" field.
func LoginTokenIn(vs ...string) predicate.User {
	return predicate.User(sql.FieldIn(FieldLoginToken, vs...))
}

// LoginTokenNotIn applies the NotIn predicate on the "LoginToken" field.
func LoginTokenNotIn(vs ...string) predicate.User {
	return predicate.User(sql.FieldNotIn(FieldLoginToken, vs...))
}

// LoginTokenGT applies the GT predicate on the "LoginToken" field.
func LoginTokenGT(v string) predicate.User {
	return predicate.User(sql.FieldGT(FieldLoginToken, v))
}

// LoginTokenGTE applies the GTE predicate on the "LoginToken" field.
func LoginTokenGTE(v string) predicate.User {
	return predicate.User(sql.FieldGTE(FieldLoginToken, v))
}

// LoginTokenLT applies the LT predicate on the "LoginToken" field.
func LoginTokenLT(v string) predicate.User {
	return predicate.User(sql.FieldLT(FieldLoginToken, v))
}

// LoginTokenLTE applies the LTE predicate on the "LoginToken" field.
func LoginTokenLTE(v string) predicate.User {
	return predicate.User(sql.FieldLTE(FieldLoginToken, v))
}

// LoginTokenContains applies the Contains predicate on the "LoginToken" field.
func LoginTokenContains(v string) predicate.User {
	return predicate.User(sql.FieldContains(FieldLoginToken, v))
}

// LoginTokenHasPrefix applies the HasPrefix predicate on the "LoginToken" field.
func LoginTokenHasPrefix(v string) predicate.User {
	return predicate.User(sql.FieldHasPrefix(FieldLoginToken, v))
}

// LoginTokenHasSuffix applies the HasSuffix predicate on the "LoginToken" field.
func LoginTokenHasSuffix(v string) predicate.User {
	return predicate.User(sql.FieldHasSuffix(FieldLoginToken, v))
}

// LoginTokenIsNil applies the IsNil predicate on the "LoginToken" field.
func LoginTokenIsNil() predicate.User {
	return predicate.User(sql.FieldIsNull(FieldLoginToken))
}

// LoginTokenNotNil applies the NotNil predicate on the "LoginToken" field.
func LoginTokenNotNil() predicate.User {
	return predicate.User(sql.FieldNotNull(FieldLoginToken))
}

// LoginTokenEqualFold applies the EqualFold predicate on the "LoginToken" field.
func LoginTokenEqualFold(v string) predicate.User {
	return predicate.User(sql.FieldEqualFold(FieldLoginToken, v))
}

// LoginTokenContainsFold applies the ContainsFold predicate on the "LoginToken" field.
func LoginTokenContainsFold(v string) predicate.User {
	return predicate.User(sql.FieldContainsFold(FieldLoginToken, v))
}

// ExpiredTimeEQ applies the EQ predicate on the "ExpiredTime" field.
func ExpiredTimeEQ(v string) predicate.User {
	return predicate.User(sql.FieldEQ(FieldExpiredTime, v))
}

// ExpiredTimeNEQ applies the NEQ predicate on the "ExpiredTime" field.
func ExpiredTimeNEQ(v string) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldExpiredTime, v))
}

// ExpiredTimeIn applies the In predicate on the "ExpiredTime" field.
func ExpiredTimeIn(vs ...string) predicate.User {
	return predicate.User(sql.FieldIn(FieldExpiredTime, vs...))
}

// ExpiredTimeNotIn applies the NotIn predicate on the "ExpiredTime" field.
func ExpiredTimeNotIn(vs ...string) predicate.User {
	return predicate.User(sql.FieldNotIn(FieldExpiredTime, vs...))
}

// ExpiredTimeGT applies the GT predicate on the "ExpiredTime" field.
func ExpiredTimeGT(v string) predicate.User {
	return predicate.User(sql.FieldGT(FieldExpiredTime, v))
}

// ExpiredTimeGTE applies the GTE predicate on the "ExpiredTime" field.
func ExpiredTimeGTE(v string) predicate.User {
	return predicate.User(sql.FieldGTE(FieldExpiredTime, v))
}

// ExpiredTimeLT applies the LT predicate on the "ExpiredTime" field.
func ExpiredTimeLT(v string) predicate.User {
	return predicate.User(sql.FieldLT(FieldExpiredTime, v))
}

// ExpiredTimeLTE applies the LTE predicate on the "ExpiredTime" field.
func ExpiredTimeLTE(v string) predicate.User {
	return predicate.User(sql.FieldLTE(FieldExpiredTime, v))
}

// ExpiredTimeContains applies the Contains predicate on the "ExpiredTime" field.
func ExpiredTimeContains(v string) predicate.User {
	return predicate.User(sql.FieldContains(FieldExpiredTime, v))
}

// ExpiredTimeHasPrefix applies the HasPrefix predicate on the "ExpiredTime" field.
func ExpiredTimeHasPrefix(v string) predicate.User {
	return predicate.User(sql.FieldHasPrefix(FieldExpiredTime, v))
}

// ExpiredTimeHasSuffix applies the HasSuffix predicate on the "ExpiredTime" field.
func ExpiredTimeHasSuffix(v string) predicate.User {
	return predicate.User(sql.FieldHasSuffix(FieldExpiredTime, v))
}

// ExpiredTimeEqualFold applies the EqualFold predicate on the "ExpiredTime" field.
func ExpiredTimeEqualFold(v string) predicate.User {
	return predicate.User(sql.FieldEqualFold(FieldExpiredTime, v))
}

// ExpiredTimeContainsFold applies the ContainsFold predicate on the "ExpiredTime" field.
func ExpiredTimeContainsFold(v string) predicate.User {
	return predicate.User(sql.FieldContainsFold(FieldExpiredTime, v))
}
