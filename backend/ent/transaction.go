...
func (*Transaction) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case transaction.FieldTransactionTime, transaction.FieldFrom, transaction.FieldTo:
...
func (t *Transaction) String() string {
	...
	builder.WriteString(t.From.Format(time.ANSIC))
	builder.WriteString(", ")
	builder.WriteString("To=")
	builder.WriteString(t.To.Format(time.ANSIC))
	builder.WriteString(", ")
