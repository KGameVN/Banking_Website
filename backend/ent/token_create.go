...
func (tc *TokenCreate) SetExpiredtime(t time.Time) *TokenCreate {
	tc.mutation.SetExpiredtime(t)
	return tc
}

// SetNillableExpiredtime sets the "expiredtime" field if the given value is not nil.
func (tc *TokenCreate) SetNillableExpiredtime(t *time.Time) *TokenCreate {
	if t != nil {
		tc.SetExpiredtime(*t)
	}
	return tc
...
func (tc *TokenCreate) SetIsUsing(b bool) *TokenCreate {
	tc.mutation.SetIsUsing(b)
	return tc
}

// SetNillableIsUsing sets the "is_using" field if the given value is not nil.
func (tc *TokenCreate) SetNillableIsUsing(b *bool) *TokenCreate {
	if b != nil {
		tc.SetIsUsing(*b)
	}
	return tc
...
func (tc *TokenCreate) defaults() {
	if _, ok := tc.mutation.Expiredtime(); !ok {
		v := token.DefaultExpiredtime()
		tc.mutation.SetExpiredtime(v)
	}
	if _, ok := tc.mutation.IsUsing(); !ok {
		v := token.DefaultIsUsing
		tc.mutation.SetIsUsing(v)
	}
}
...
func (tc *TokenCreate) check() error {
	...
	if _, ok := tc.mutation.Expiredtime(); !ok {
		return &ValidationError{Name: "expiredtime", err: errors.New(`ent: missing required field "Token.expiredtime"`)}
	}
	if _, ok := tc.mutation.IsUsing(); !ok {
		return &ValidationError{Name: "is_using", err: errors.New(`ent: missing required field "Token.is_using"`)}
	}
	return nil
}
...
func (tc *TokenCreate) createSpec() (*Token, *sqlgraph.CreateSpec) {
	...
	if value, ok := tc.mutation.IsUsing(); ok {
