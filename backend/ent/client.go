...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.LoginToken, c.Transaction, c.Transfer, c.User, c.UserAccount, c.UserProfile,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		LoginToken, Transaction, Transfer, User, UserAccount, UserProfile []ent.Hook
	}
	inters struct {
		LoginToken, Transaction, Transfer, User, UserAccount,
