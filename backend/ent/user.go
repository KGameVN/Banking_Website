...
type User struct {
	...
	// LoginToken holds the value of the "LoginToken" field.
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldUsername, user.FieldFullname, user.FieldEmail, user.FieldPassword, user.FieldLoginToken, user.FieldExpiredTime:
...
func (u *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldLoginToken:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field LoginToken", values[i])
			} else if value.Valid {
...
func (u *User) String() string {
	...
	builder.WriteString(u.ExpiredTime)
	builder.WriteString(", ")
